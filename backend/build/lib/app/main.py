...
# Importar schemas de auth
from app.models.schemas import User, UserCreate, Token

# Crear app
app = FastAPI(title="API Taller - JWT + Rate Limiting")
...
# Función para obtener key de rate limiting (usuario o IP)
...
async def login(request: Request, form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    record = USERS_DB.get(form_data.username)
...
# Configurar dependencia de autenticación en los routers
app.include_router(
...
# Importar servicios para inicializar datos en memoria
